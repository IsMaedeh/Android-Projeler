...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Kaydet.setOnClickListener(view -> {
            Log.d(TAG, "Kayıt Ekle butonuna basıld1");
    ...
    private void KayitEkle(String adi, String soyadi, String yasi, String sehri) {
        try {
            ...
            veriler.put("yas", Integer.parseInt(yasi)); // Yasi integer olarak ekleyin
    ...
    private void KayitGuncelle(String adi, String soyadi, String yasi, String sehri) {
        try {
            ...
            cvGuncelle.put("yas", Integer.parseInt(yasi)); // Yasi integer olarak güncelleyin
