...
#define EI_CLASSIFIER_TFLITE_LEARN_5_ARENA_SIZE     1548236
const size_t tflite_learn_5_arena_size = 1548236;

INCBIN(incbin_tflite_learn_5, "tflite-model/tflite_learn_5.tflite");

const unsigned char *tflite_learn_5 = gincbin_tflite_learn_5_data;
unsigned int tflite_learn_5_len = gincbin_tflite_learn_5_size;
